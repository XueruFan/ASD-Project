...
for (id in id_group){
  ...
  name <- paste0("abide_A_asd_male_dev_Spectral_Cluster_34DK_", id, "_Centile_Global_", newDate, ".png")
...
name <- paste0("abide_A_asd_male_dev_Spectral_Cluster_2_34DK_Centile_Brain_", newDate, ".png")
ggsave(file.path(plotDir, name), width = 7.8, height = 3, units = "in", dpi = 500)
