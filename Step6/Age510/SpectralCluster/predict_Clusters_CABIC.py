# -*- coding: utf-8 -*-
"""
Apply the pre-trained nonlinear kernel model to predict new data
@author: xueru
"""
import os
import pandas as pd
...
# 定义路径
abideDir = 'E:/PhDproject/ABIDE/Analysis/Cluster/Spect510'  # Windows
...
# 2. 读取新的数据集
new_data = pd.read_csv(os.path.join(cabicDir, f"cabic_centile_510_{newDate}.csv"))
...
# 保存预测结果到 CSV 文件
output_file = os.path.join(cabicDir, f'cabic_cluster_predictions_510_{newDate}.csv')
