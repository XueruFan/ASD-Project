...
# 定义路径
abideDir = 'E:/PhDproject/ABIDE/Analysis/Cluster/GMM513'  # Windows
cabicDir = 'E:/PhDproject/CABIC/result'
resdir = 'E:/PhDproject/CABIC/result/pred/GMM513'
newDate = "240928"
...
# 保存预测结果到 CSV 文件
output_file = os.path.join(resdir, f'cabic_cluster_predictions_513_{newDate}.csv')
