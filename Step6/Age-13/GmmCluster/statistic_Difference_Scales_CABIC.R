...
resuDir <- file.path(cabicDir, "result/pred/GMM513/Diff")
plotDir <- file.path(cabicDir, "result/pred/GMM513/Plot/Diff")
resDate <- "240928"
...
cluster <- read.csv(file.path(cabicDir, "result/pred/GMM513", name))
