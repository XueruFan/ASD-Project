...
resDir <- file.path(abideDir, "Analysis/Cluster/Spect509")
plotDir <- file.path(abideDir, "Plot/Cluster/Spect509")
resDate <- "240315"
newDate <- "240610"

abide_centile <- read.csv(file.path(dataDir, paste0("abide_All_centile_509_", resDate, ".csv")))
