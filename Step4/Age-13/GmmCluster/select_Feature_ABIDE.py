...
resDir = os.path.join(abideDir, "Analysis", "Cluster", "GMM513")
plotDir = os.path.join(abideDir, "Plot", "Cluster", "GMM513")
newDate = "240610"
...
brain_codes = ['rostralmiddlefrontal', 'parstriangularis', 'parsopercularis', 'superiorparietal', 'insula', 
               'isthmuscingulate', 'superiorfrontal', 'inferiorparietal', 'medialorbitofrontal', 'postcentral']

custom_feature_names = ['Rostral middle frontal',
                        'Pars triangularis',
                        'Pars opercularis',
                        'Superior parietal',
                        'Insula', 
