...
# features to subgroup male ASD individuals (6~9.9 years) from the ABIDE dataset.
...
abide_centile <- read.csv(file.path(dataDir, paste0("abide_All_centile_610_", resDate, ".csv")))
