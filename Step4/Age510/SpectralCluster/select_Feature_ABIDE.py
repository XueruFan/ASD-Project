...
resDir = os.path.join(abideDir, "Analysis", "Cluster", "Spect510")
plotDir = os.path.join(abideDir, "Plot", "Cluster", "Spect510")
newDate = "240610"
...
brain_codes = ['superiortemporal', 'parsopercularis', 'parstriangularis', 'lateralorbitofrontal', 'postcentral',
                'middletemporal', 'medialorbitofrontal', 'insula', 'bankssts', 'lateraloccipital']

custom_feature_names = ['Superior temporal',
                        'Pars opercularis',
                        'Pars triangularis',
