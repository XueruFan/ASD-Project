...
resDir <- file.path(abideDir, "Analysis/Cluster/Spect711")
plotDir <- file.path(abideDir, "Plot/Cluster/Spect711")
resDate <- "240315"
newDate <- "240610"

abide_centile <- read.csv(file.path(dataDir, paste0("abide_All_centile_711_", resDate, ".csv")))
