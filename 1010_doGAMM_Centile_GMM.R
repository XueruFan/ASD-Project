...
# 保存模型统计值到 Excel 文件
write.xlsx(model_stats, file.path(statDir, paste0("asd_male_dev_GC_statis_GAMM_NegSite_", newDate,
...
# 保存模型统计值到 Excel 文件
write.xlsx(model_stats, file.path(statDir, paste0("asd_male_dev_GC_statis_GAMM_ConSite_", newDate,
                                                  ".xlsx")), rowNames = F, colNames = T)
