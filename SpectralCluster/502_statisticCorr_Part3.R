...
### 保存下来结果
name <- paste0("asd_male_dev_SC_corr_Part3_SiteFIQ_L_", newDate, ".csv")
...
### 保存下来结果
name <- paste0("asd_male_dev_SC_corr_Part3_SiteFIQ_H_", newDate, ".csv")
...
name <- paste0("asd_male_dev_SC_corr_Part3_SiteFIQ_LH_", newDate, ".csv")
...
for (i in 1:nrow(sorted)) {
  ...
  name <- paste0("SC_corr_Part3_SiteFIQ_", to_plot_names[1], "_", to_plot_names[2], "_", newDate, ".png")
...
### 保存下来结果
name <- paste0("asd_male_dev_SC_corr_Part3_Site_L_", newDate, ".csv")
write.csv(L_sorted, file.path(statiDir, name), row.names = F)
...
### 保存下来结果
name <- paste0("asd_male_dev_SC_corr_Part3_Site_H_", newDate, ".csv")
write.csv(H_sorted, file.path(statiDir, name), row.names = F)
...
name <- paste0("asd_male_dev_SC_corr_Part3_Site_LH_", newDate, ".csv")
write.csv(sorted[, -7], file.path(statiDir, name), row.names = F)
...
for (i in 1:nrow(sorted)) {
  ...
  name <- paste0("SC_corr_Part3_Site_", to_plot_names[1], "_", to_plot_names[2], "_", newDate, ".png")
  ggsave(file.path(plotDir, name), width = 7, height = 7, units = "in", dpi = 500)
}
