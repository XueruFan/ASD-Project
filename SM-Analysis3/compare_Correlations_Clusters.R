...
cabicDir <- 'E:/PhDproject/CABIC/result/inde/Spect-13'
...
write.xlsx(l_all, file.path(resuDir, "l_corr_part4_bothABIDEandIndeCABIC.xlsx"), rowNames = F)
write.xlsx(h_all, file.path(resuDir, "h_corr_part4_bothABIDEandIndeCABIC.xlsx"), rowNames = F)
