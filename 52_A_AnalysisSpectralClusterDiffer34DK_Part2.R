...
name <- paste0("abide_A_asd_male_dev_Spectral_Cluster_34DK_statis_CBCL_", newDate, ".csv")
...
name <- paste0("abide_A_asd_male_dev_Spectral_Cluster_34DK_statis_Pvalue_Part2_", newDate, ".csv")
