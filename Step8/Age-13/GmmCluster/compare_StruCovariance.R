# Compare structural covariance results between ABIDE and CABIC
...
cabicDir <- 'E:/PhDproject/CABIC/result/pred/GMM513/StruCorr'
resuDir <- file.path(abideDir, "Analysis/Statistic/GMM513")
