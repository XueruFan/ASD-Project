...
# 有4个ASD男性被去掉了，找到他们，其中abide1有3个，abide2有1个
...
################################# save plot
name <- paste0("asd_male_Spectral_Cluster_Silhouette_", newDate, ".png")
...
################################# save plot
name <- paste0("asd_male_Spectral_Cluster_RMrank_", newDate, ".png")
ggsave(file.path(plotDir, name), width = 7, height = 8, units = "in", dpi = 500)


################################# 保存该结果
name <- paste0("asd_male_Spectral_Cluster_RMrank_", newDate, ".csv")
