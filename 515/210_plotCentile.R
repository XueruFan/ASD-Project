...
name_regional <- paste0("centile_regional_density_515_", newDate, ".png")
...
name <- file.path(plotDir, paste0("centile_regional_median_515_", newDate, ".png"))
...
name_global <- paste0("centile_global_density_515_", newDate, ".png")
