...
### 保存下来结果
name <- paste0("asd_male_dev_SC_corr_Part2_34_L_", newDate, ".csv")
...
### 保存下来结果
name <- paste0("asd_male_dev_SC_corr_Part2_34_H_", newDate, ".csv")
...
### 保存下来结果
name <- paste0("asd_male_dev_SC_corr_Part2_05_L_", newDate, ".csv")
write.csv(L_sorted, file.path(statiDir, name), row.names = F)
...
### 保存下来结果
name <- paste0("asd_male_dev_SC_corr_Part2_05_H_", newDate, ".csv")
write.csv(H_sorted, file.path(statiDir, name), row.names = F)
...
name <- paste0("asd_male_dev_SC_corr_Part2_05_LH_", newDate, ".csv")
...
for (i in 1:nrow(sorted)) {
  ...
  name <- paste0("SC_corr_Part2_05_", to_plot_names[1], "_", to_plot_names[2], "_", newDate, ".png")
