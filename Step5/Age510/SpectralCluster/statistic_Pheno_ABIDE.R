# Analyze ABIDE (individuals used for clustering analysis) composition
...
resDir <- file.path(abideDir, "Analysis/Statistic/Spect510")
resDate <- "240315"
newDate <- "240610"
...
cluster_id <- read.csv(file.path(abideDir, "Analysis/Cluster/Spect510", name))[, 2]
