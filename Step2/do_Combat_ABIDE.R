# Do ComBat analysis for ABIDE data
...
abide_all <- read.csv(file.path(dataDir,  paste0("abide_All_forComBat_", resDate, ".csv")))
...
# save result
name <-  paste0("abide_All_forCentile_", resDate, ".csv")
