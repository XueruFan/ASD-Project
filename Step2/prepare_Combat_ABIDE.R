# Combine ABIDE demographic and MRI measurements, format based on LBCC standards for subsequent  
# Combat harmonization and individual OoS calculation.
# Xue-Ru Fan 11 May 2023 @BNU
###################################################
# Part 1: Combine demographic, cognitive and MRI measurements of ABIDE 1 and 2
