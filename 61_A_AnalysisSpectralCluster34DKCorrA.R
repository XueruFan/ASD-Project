...
### 保存下来结果
name <- paste0("abide_A_asd_male_dev_Spectral_Cluster_34DK_statis_CorrA_L_", newDate, ".csv")
...
### 保存下来结果
name <- paste0("abide_A_asd_male_dev_Spectral_Cluster_34DK_statis_CorrA_H_", newDate, ".csv")
