...
plotDir <- file.path(abideDir, "Plot/Cluster/GmmCluster/Centile/GAMM")
statDir <- file.path(abideDir, "Analysis/Statistic/GmmCluster")
resDate <- "240315"
newDate <- "240610"

stat <- read.xlsx(file.path(statDir, paste0("asd_male_dev_GC_statis_GAMM_", newDate, ".xlsx")))
...
name <- paste0("GC_statis_GAMM_R2_L_", newDate, ".png")
...
name <- paste0("GC_statis_GAMM_R2_H_", newDate, ".png")
ggsave(file.path(plotDir, name), width = 7.8, height = 3, units = "in", dpi = 500)
...
name <- paste0("GC_statis_GAMM_R2p_L_", newDate, ".png")
ggsave(file.path(plotDir, name), width = 7.8, height = 3, units = "in", dpi = 500)
...
name <- paste0("GC_statis_GAMM_R2p_H_", newDate, ".png")
ggsave(file.path(plotDir, name), width = 7.8, height = 3, units = "in", dpi = 500)
