...
names_cog <- c("ADOS_2_SEVERITY_TOTAL", "ADOS_2_TOTAL", "ADOS_2_RRB", "BMI")
...
for (volumeName in volumeNames) {
  ...
  # 保存图像
  name <- paste0("GC_Corr_GAMM_", volumeName, "_", newDate, ".png")
