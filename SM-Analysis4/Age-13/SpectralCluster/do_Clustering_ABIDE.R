...
# features to subgroup male ASD individuals from the ABIDE dataset - NYU Stie only
...
# 
# ################################# save plot
# name <- paste0("Silhouette_NYU_", newDate, ".png")
...
name <- paste0("Cluster_NYU_only_", newDate, ".csv")
