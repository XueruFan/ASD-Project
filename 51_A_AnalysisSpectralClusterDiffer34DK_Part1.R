...
name <- paste0("abide_A_asd_male_dev_Spectral_Cluster_34DK_statis_site_", newDate, ".csv")
...
# save plot
name <- paste0("abide_A_asd_male_dev_Spectral_Cluster_34DK_differ_site_", newDate, ".png")
...
name <- paste0("abide_A_asd_male_dev_Spectral_Cluster_34DK_statis_scaner_", newDate, ".csv")
...
ggplot(data_long, aes(x = Scan, y = value, fill = variable)) +
  ...
  theme(legend.position = "none", # without legend
        ...
        axis.text.x = element_text(size = 10, face = "bold", angle = 45, hjust = 1))
# save plot
name <- paste0("abide_A_asd_male_dev_Spectral_Cluster_34DK_differ_scanner_", newDate, ".png")
...
name <- paste0("abide_A_asd_male_dev_Spectral_Cluster_34DK_statis_manu_", newDate, ".csv")
...
# save plot
name <- paste0("abide_A_asd_male_dev_Spectral_Cluster_34DK_differ_manu_", newDate, ".png")
ggsave(file.path(plotDir, name), width = 5, height = 4, units = "in", dpi = 500)
...
name <- paste0("abide_A_asd_male_dev_Spectral_Cluster_34DK_statis_type_", newDate, ".csv")
...
ggplot(data_long, aes(x = type, y = value, fill = variable)) +
  ...
  theme(legend.position = "none", # without legend
        ...
        axis.text.x = element_text(size = 10, face = "bold"))
# save plot
name <- paste0("abide_A_asd_male_dev_Spectral_Cluster_34DK_differ_type_", newDate, ".png")
ggsave(file.path(plotDir, name), width = 5, height = 4, units = "in", dpi = 500)
...
# save plot
name <- paste0("abide_A_asd_male_dev_Spectral_Cluster_34DK_differ_age_", newDate, ".png")
ggsave(file.path(plotDir, name), width = 6, height = 4, units = "in", dpi = 500)
...
name <- paste0("abide_A_asd_male_dev_Spectral_Cluster_34DK_statis_age_", newDate, ".csv")
...
# save plot
name <- paste0("abide_A_asd_male_dev_Spectral_Cluster_34DK_differ_IQ_", newDate, ".png")
...
name <- paste0("abide_A_asd_male_dev_Spectral_Cluster_34DK_statis_iq_", newDate, ".csv")
...
name <- paste0("abide_A_asd_male_dev_Spectral_Cluster_34DK_differ_ADOS_G_raw_", newDate, ".png")
...
name <- paste0("abide_A_asd_male_dev_Spectral_Cluster_34DK_statistic_ADOS_G_raw_", newDate, ".csv")
write.csv(sta_ana, file.path(statiDir, name))
...
name <- paste0("abide_A_asd_male_dev_Spectral_Cluster_34DK_differ_ADOS_2_raw_", newDate, ".png")
ggsave(file.path(plotDir, name), width = 7, height = 6, units = "in", dpi = 500)
...
name <- paste0("abide_A_asd_male_dev_Spectral_Cluster_34DK_stastic_ADOS_2_raw_", newDate, ".csv")
write.csv(sta_ana, file.path(statiDir, name))
...
name <- paste0("abide_A_asd_male_dev_Spectral_Cluster_34DK_differ_SRS_sub_raw_", newDate, ".png")
ggsave(file.path(plotDir, name), width = 7, height = 6, units = "in", dpi = 500)
...
name <- paste0("abide_A_asd_male_dev_Spectral_Cluster_34DK_statis_SRS_sub_raw_", newDate, ".csv")
write.csv(sta_ana, file.path(statiDir, name))
...
name <- paste0("abide_A_asd_male_dev_Spectral_Cluster_34DK_differ_SRS_sub_trans_", newDate, ".png")
ggsave(file.path(plotDir, name), width = 7, height = 6, units = "in", dpi = 500)
...
name <- paste0("abide_A_asd_male_dev_Spectral_Cluster_34DK_statis_SRS_sub_trans_", newDate, ".csv")
write.csv(sta_ana, file.path(statiDir, name))
...
name <- paste0("abide_A_asd_male_dev_Spectral_Cluster_34DK_differ_SRS_total_", newDate, ".png")
ggsave(file.path(plotDir, name), width = 7, height = 6, units = "in", dpi = 500)
...
name <- paste0("abide_A_asd_male_dev_Spectral_Cluster_34DK_statis_SRS_total_", newDate, ".csv")
write.csv(sta_ana, file.path(statiDir, name))
...
name <- paste0("abide_A_asd_male_dev_Spectral_Cluster_34DK_differ_ADIR_raw_", newDate, ".png")
ggsave(file.path(plotDir, name), width = 7, height = 6, units = "in", dpi = 500)
...
name <- paste0("abide_A_asd_male_dev_Spectral_Cluster_34DK_statis_ADIR_raw_", newDate, ".csv")
write.csv(sta_ana, file.path(statiDir, name))
...
name <- paste0("abide_A_asd_male_dev_Spectral_Cluster_34DK_differ_VIN_stand_", newDate, ".png")
ggsave(file.path(plotDir, name), width = 7, height = 6, units = "in", dpi = 500)
...
name <- paste0("abide_A_asd_male_dev_Spectral_Cluster_34DK_statis_VIN_stand_", newDate, ".csv")
write.csv(sta_ana, file.path(statiDir, name))
...
name <- paste0("abide_A_asd_male_dev_Spectral_Cluster_34DK_differ_VIN_scale_", newDate, ".png")
...
name <- paste0("abide_A_asd_male_dev_Spectral_Cluster_34DK_statis_VIN_scale_", newDate, ".csv")
write.csv(sta_ana, file.path(statiDir, name))
...
ggplot(var, aes(x = variable, y = factor(clusterID, levels = c("L", "H")), fill = clusterID)) +
  ...
  theme(legend.position = "none", # without legend
        ...
        axis.text.x = element_text(size = 16, face = "bold", vjust = 10))
# save plot
name <- paste0("abide_A_asd_male_dev_Spectral_Cluster_34DK_differ_bmi_", newDate, ".png")
ggsave(file.path(plotDir, name), width = 6, height = 4, units = "in", dpi = 500)
...
name <- paste0("abide_A_asd_male_dev_Spectral_Cluster_34DK_statis_bmi_", newDate, ".csv")
write.csv(sta_ana, file.path(statiDir, name), row.names = F)
...
name <- paste0("abide_A_asd_male_dev_Spectral_Cluster_34DK_statis_Pvalue_Part1_", newDate, ".csv")
