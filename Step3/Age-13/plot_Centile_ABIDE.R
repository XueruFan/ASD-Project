# Plot OoS centile scores for ABIDE data
# Xue-Ru Fan 25 April 2023 @BNU
###################################################
# Part 1: Plot the probability density of OoS centile (median) for 34 regional volumes in ASD males
# Part 2: Project the OoS centile (median) for 34 regional volumes in ASD males on brain
# Part 3: Plot the probability density of OoS centile (median) for 7 global measures in ASD males
###################################################
...
# save the median
name <- paste0("centile_median_513_", newDate, ".xlsx")
