...
#### select: 控制变量、自变量、因变量
names_col <- c("predicted_cluster", "TCV", "Age", names_brain[-4], names_cog)
...
### 保存下来结果
name <- paste0("cabic_Part7_H_", resDate, ".csv")
write.csv(H_sorted, file.path(resuDir, name), row.names = F)
name <- paste0("cabic_Part7_L_", resDate, ".csv")
