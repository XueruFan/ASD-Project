...
resuDir <- file.path(cabicDir, "result/inde/515/Diff")
plotDir <- file.path(cabicDir, "result/inde/515/Plot/Diff")
resDate <- "240928"
...
ggplot(var, aes(x = variable, y = factor(clusterID, levels = c("L", "H")), fill = clusterID)) +
  ...
  scale_x_continuous(breaks = seq(5, 15, by = 2), labels = c("5岁", "7", "9", "11", "13", "15")) +
