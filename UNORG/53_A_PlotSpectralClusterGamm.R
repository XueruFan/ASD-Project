...
plotDir <- file.path(abideDir, "Plot/Cluster/Cluster_A/SpectralCluster/GAMM")
resDate <- "240315"
newDate <- "240610"
...
for (volumeName in volumeNames){
  ...
  name <- paste0("abide_A_asd_male_dev_Spectral_Cluster_", volumeName, "_GAMLSS_", newDate,".png")
