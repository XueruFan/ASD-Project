...
### 保存下来结果
name <- paste0("abide_A_asd_male_dev_Spectral_Cluster_statis_CorrD_L_", newDate, ".csv")
...
### 保存下来结果
name <- paste0("abide_A_asd_male_dev_Spectral_Cluster_statis_CorrD_H_", newDate, ".csv")
