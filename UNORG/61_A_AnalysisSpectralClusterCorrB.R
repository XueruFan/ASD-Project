...
### 保存下来结果
name <- paste0("abide_A_asd_male_dev_Spectral_Cluster_statis_CorrB_L_", newDate, ".csv")
...
### 保存下来结果
name <- paste0("abide_A_asd_male_dev_Spectral_Cluster_statis_CorrB_H_", newDate, ".csv")
