...
for (id in id_group){
  ...
  name <- paste0("abide_A_asd_male_dev_GMM_Cluster_", id, "_Centile_Regional_", newDate, ".png")
  ggsave(file.path(plotDir, name), width = 4.6, height = 6, units = "in", dpi = 500)
}

objects_to_keep <- c("plotDir", "abideDir", "dataDir", "newDate", "cluster_result", "id_group", "resDir")
...
for (id in id_group){
  ...
  name <- paste0("abide_A_asd_male_dev_GMM_Cluster_", id, "_Centile_Global_", newDate, ".png")
...
name <- paste0("abide_A_asd_male_dev_GMM_Cluster_1_Centile_Brain_", newDate, ".png")
...
name <- paste0("abide_A_asd_male_dev_GMM_Cluster_2_Centile_Brain_", newDate, ".png")
ggsave(file.path(plotDir, name), width = 7.8, height = 3, units = "in", dpi = 500)
...
name <- paste0("abide_A_asd_male_dev_GMM_Cluster_1_Abno5_Rank_", newDate, ".csv")
...
ggseg(.data = abno_g1, mapping = aes(fill = perc), color = "black", atlas = dk,
  ...
  guides(fill = guide_colourbar(frame.colour = "black", frame.linewidth = 1, ticks = FALSE))
name <- paste0("abide_A_asd_male_dev_GMM_Cluster_1_Abno5_Brain_", newDate, ".png")
ggsave(file.path(plotDir, name), width = 7.8, height = 3, units = "in", dpi = 500)
# 大于95%
...
ggseg(.data = abno_g1, mapping = aes(fill = perc), color = "black", atlas = dk,
  ...
  scale_fill_viridis_c(option = "inferno") +
  guides(fill = guide_colourbar(frame.colour = "black", frame.linewidth = 1, ticks = FALSE))
name <- paste0("abide_A_asd_male_dev_GMM_Cluster_1_Abno95_Brain_", newDate, ".png")
ggsave(file.path(plotDir, name), width = 7.8, height = 3, units = "in", dpi = 500)
...
name <- paste0("abide_A_asd_male_dev_GMM_Cluster_2_Abno95_Rank_", newDate, ".csv")
...
ggseg(.data = abno_g2, mapping = aes(fill = perc), color = "black", atlas = dk,
  ...
  scale_fill_viridis_c(option = "inferno") +
  guides(fill = guide_colourbar(frame.colour = "black", frame.linewidth = 1, ticks = FALSE))
name <- paste0("abide_A_asd_male_dev_GMM_Cluster_2_Abno95_Brain_", newDate, ".png")
ggsave(file.path(plotDir, name), width = 7.8, height = 3, units = "in", dpi = 500)
# 小于5%
...
ggseg(.data = abno_g2, mapping = aes(fill = perc), color = "black", atlas = dk,
  ...
  scale_fill_viridis_c(option = "inferno") +
  guides(fill = guide_colourbar(frame.colour = "black", frame.linewidth = 1, ticks = FALSE))
name <- paste0("abide_A_asd_male_dev_GMM_Cluster_2_Abno5_Brain_", newDate, ".png")
ggsave(file.path(plotDir, name), width = 7.8, height = 3, units = "in", dpi = 500)