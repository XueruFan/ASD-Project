...
CABIC$predicted_cluster[CABIC$predicted_cluster == 2] <- "H"
CABIC <- CABIC %>% rename(clusterID = predicted_cluster)
...
name <- paste0("corr_Part4_Both_H_", newDate, ".csv")
...
name <- paste0("corr_Part4_ADOS_SA_transversetemporal", newDate, ".png")
...
name <- paste0("corr_Part4_ADOS_RRB_inferiortemporal", newDate, ".png")
ggsave(file.path(plotDir, name), width = 7, height = 7, units = "in", dpi = 500)
...
name <- paste0("corr_Part4_ADOS_Total_transversetemporal", newDate, ".png")
ggsave(file.path(plotDir, name), width = 7, height = 7, units = "in", dpi = 500)
...
name <- paste0("corr_Part4_SRS_AM_isthmuscingulate", newDate, ".png")
ggsave(file.path(plotDir, name), width = 7, height = 7, units = "in", dpi = 500)
