# Use GAMM to explore the relationship between OoS scores and age within subgroup H for CABIC
...
# 保存模型统计值到 Excel 文件
write.xlsx(model_stats, file.path(resuDir, paste0("gamm_Centile_", resDate,
