...
plotDir <- file.path(abideDir, "Plot/Cluster/Spect510/LBCC_Both")
newDate <- "240610"

# define variables
id_group <- c("1") # this code is for H clusters
...
for (volumeName in volumeNames){
  ...
  ageLimits <- c(5, 10)  # 限制绘图的年龄范围为5到13岁
